...
print("mean,median,mode height is {},{},{}".format(height_mean,height_median,height_mode))
print("mean,median,mode weight is {},{},{}".format(weight_mean,weight_median,weight_mode))
